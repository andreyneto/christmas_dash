game_scene=scene:extend({
	...
	update=function(_ENV)
		...
		if #snowball.pool == 0 and global.speed >= 1.2 and
		(score.distance%100 == 0 or score.points % 1000 == 0 or score.coins %50 == 0)
		then snowball({x=130,y=mid(16,rnd(16)*16,80)}) end
		logo_x-=speed
		chunk:each("update")
		entity:each("update")
		entity:each("animate")
